                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control form-control-sm" type="date" name="incidentDate"
                                        id="incidentDate" value="{{ now('Asia/kolkata')->toDateString('Y-m-d') }}"
                                        readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control form-control-sm" type="time" name="incidentTime"
                                        id="incidentTime" value="{{ now('Asia/kolkata')->toTimeString() }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    //         var forms = $("#nearMissForm");
    //         $.ajax({
    //             url: "action/action-nearMiss.php",
    //             type: "POST",
    //             data: forms.serialize(),
    //             success: function(data) {
    //                 $("#spinner").hide();
    ...
    //                     setTimeout(function() {
    //                         window.location.href = "nearMiss-table.php"
    //                     }, 5000);
    //                 } else {
    //                     toastr.error(data);
    //                 }
